...
var _scrollreveal = __webpack_require__(3);
...
var leftSlider = new Swiper('.left-slider__container', {
  direction: 'vertical',
  simulateTouch: false,
  autoplay: true,
  effect: 'fade'
...
var rightSlider = new Swiper('.right-slider__container', {
  direction: 'vertical',
  slidesPerView: 4,
  simulateTouch: false,
...
var clientSlider = new Swiper('.about__clients-list', {
  slidesPerView: 5,
  loop: true,
  spaceBetween: 16
});
...
var navExpanded = Array.from(sidebarNav.querySelectorAll('li.expanded'));
...
navExpanded.map(function (item) {
  if (item.querySelector('ul')) {
    ...
    var innerList = item.querySelector('ul');
  ...
  var button = item.querySelector('span');
...
Array.from(document.querySelectorAll('.solutions__gallery-item-title')).map(function (item) {
  item.addEventListener('click', function (event) {
    Array.from(document.querySelectorAll('.solutions__gallery-item-title')).map(function (_item) {
...
_vue2.default.prototype.$myApp = 'orbis';
